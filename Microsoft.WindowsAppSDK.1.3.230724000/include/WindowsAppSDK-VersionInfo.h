...
#define WINDOWSAPPSDK_RELEASE_MINOR                         3
#define WINDOWSAPPSDK_RELEASE_PATCH                         0
#define WINDOWSAPPSDK_RELEASE_MAJORMINOR                    0x00010003
...
#define WINDOWSAPPSDK_RUNTIME_VERSION_MAJOR             3000u
#define WINDOWSAPPSDK_RUNTIME_VERSION_MINOR             934u
#define WINDOWSAPPSDK_RUNTIME_VERSION_BUILD             1904u
#define WINDOWSAPPSDK_RUNTIME_VERSION_REVISION          0u
#define WINDOWSAPPSDK_RUNTIME_VERSION_UINT64            0x0BB803A607700000u
#define WINDOWSAPPSDK_RUNTIME_VERSION_DOTQUADSTRING     "3000.934.1904.0"
#define WINDOWSAPPSDK_RUNTIME_VERSION_DOTQUADSTRING_W   L"3000.934.1904.0"

#define WINDOWSAPPSDK_RUNTIME_PACKAGE_FRAMEWORK_PACKAGEFAMILYNAME   "Microsoft.WindowsAppRuntime.1.3_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_FRAMEWORK_PACKAGEFAMILYNAME_W L"Microsoft.WindowsAppRuntime.1.3_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_MAIN_PACKAGEFAMILYNAME        "MicrosoftCorporationII.WinAppRuntime.Main.1.3_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_MAIN_PACKAGEFAMILYNAME_W      L"MicrosoftCorporationII.WinAppRuntime.Main.1.3_8wekyb3d8bbwe"
...
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_X86_PACKAGEFAMILYNAME        "Microsoft.WinAppRuntime.DDLM.3000.934.1904.0-x8_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_X86_PACKAGEFAMILYNAME_W      L"Microsoft.WinAppRuntime.DDLM.3000.934.1904.0-x8_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_X64_PACKAGEFAMILYNAME        "Microsoft.WinAppRuntime.DDLM.3000.934.1904.0-x6_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_X64_PACKAGEFAMILYNAME_W      L"Microsoft.WinAppRuntime.DDLM.3000.934.1904.0-x6_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_ARM64_PACKAGEFAMILYNAME      "Microsoft.WinAppRuntime.DDLM.3000.934.1904.0-a6_8wekyb3d8bbwe"
#define WINDOWSAPPSDK_RUNTIME_PACKAGE_DDLM_ARM64_PACKAGEFAMILYNAME_W    L"Microsoft.WinAppRuntime.DDLM.3000.934.1904.0-a6_8wekyb3d8bbwe"
...
#define WAS_RELEASE_MINOR               3
#define WAS_RELEASE_PATCH               0
#define WAS_RELEASE_MAJORMINOR          0x00010003
...
#define WASR_VERSION_MAJOR              3000
#define WASR_VERSION_MINOR              934
#define WASR_VERSION_BUILD              1904
#define WASR_VERSION_REVISION           0
#define WASR_VERSION_UINT64             0x0BB803A607700000
#define WASR_VERSION_DOTQUADSTRING      "3000.934.1904.0"
#define WASR_VERSION_DOTQUADSTRING_W    L"3000.934.1904.0"

#define WASR_PKG_FRAMEWORK_FAMILY       "Microsoft.WindowsAppRuntime.1.3_8wekyb3d8bbwe"
#define WASR_PKG_FRAMEWORK_FAMILY_W     L"Microsoft.WindowsAppRuntime.1.3_8wekyb3d8bbwe"
#define WASR_PKG_MAIN_FAMILY            "MicrosoftCorporationII.WinAppRuntime.Main.1.3_8wekyb3d8bbwe"
#define WASR_PKG_MAIN_FAMILY_W          L"MicrosoftCorporationII.WinAppRuntime.Main.1.3_8wekyb3d8bbwe"
...
#define WASR_PKG_DDLM_X86_FAMILY        "Microsoft.WinAppRuntime.DDLM.3000.934.1904.0-x8_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_X86_FAMILY_W      L"Microsoft.WinAppRuntime.DDLM.3000.934.1904.0-x8_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_X64_FAMILY        "Microsoft.WinAppRuntime.DDLM.3000.934.1904.0-x6_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_X64_FAMILY_W      L"Microsoft.WinAppRuntime.DDLM.3000.934.1904.0-x6_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_ARM64_FAMILY      "Microsoft.WinAppRuntime.DDLM.3000.934.1904.0-a6_8wekyb3d8bbwe"
#define WASR_PKG_DDLM_ARM64_FAMILY_W    L"Microsoft.WinAppRuntime.DDLM.3000.934.1904.0-a6_8wekyb3d8bbwe"
#endif
...
namespace Microsoft::WindowsAppSDK
{
    ...
    namespace Release
    {
        ...
        constexpr uint32_t MajorMinor = 0x00010003;
    ...
    namespace Runtime
    {
        ...
        namespace Packages
        {
            namespace Framework
            {
                ...
                constexpr PCWSTR PackageFamilyName = L"Microsoft.WindowsAppRuntime.1.3_8wekyb3d8bbwe";
            }
            namespace Main
            {
                /// The Windows App SDK runtime's Main package's family name.
                constexpr PCWSTR PackageFamilyName = L"MicrosoftCorporationII.WinAppRuntime.Main.1.3_8wekyb3d8bbwe";
            }
            namespace Singleton
            {
            ...
            namespace DDLM
            {
                namespace X86
                {
                    ...
                    constexpr PCWSTR PackageFamilyName = L"Microsoft.WinAppRuntime.DDLM.3000.934.1904.0-x8_8wekyb3d8bbwe";
                }
                namespace X64
                {
                    /// The Windows App SDK runtime's Dynamic Dependency Lifetime Manager (DDLM) package's family name, for x64.
                    constexpr PCWSTR PackageFamilyName = L"Microsoft.WinAppRuntime.DDLM.3000.934.1904.0-x6_8wekyb3d8bbwe";
                }
                namespace Arm64
                {
                    /// The Windows App SDK runtime's Dynamic Dependency Lifetime Manager (DDLM) package's family name, for arm64.
                    constexpr PCWSTR PackageFamilyName = L"Microsoft.WinAppRuntime.DDLM.3000.934.1904.0-a6_8wekyb3d8bbwe";
                }
            }
        }
    }
