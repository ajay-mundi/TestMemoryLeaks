    ...
    namespace Runtime
    {
        ...
        namespace Packages
        {
            public class Framework
            {
                ...
                public const string PackageFamilyName = "Microsoft.WindowsAppRuntime.1.3_8wekyb3d8bbwe";
            }
            public class Main
            {
                /// The Windows App SDK runtime's Main package's family name.
                public const string PackageFamilyName = "MicrosoftCorporationII.WinAppRuntime.Main.1.3_8wekyb3d8bbwe";
            }
            ...
            namespace DDLM
            {
                public class X86
                {
                    ...
                    public const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.3000.934.1904.0-x8_8wekyb3d8bbwe";
                }
                public class X64
                {
                    /// The Windows App SDK runtime's Dynamic Dependency Lifetime Manager (DDLM) package's family name, for x64.
                    public const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.3000.934.1904.0-x6_8wekyb3d8bbwe";
                }
                public class Arm64
                {
                    /// The Windows App SDK runtime's Dynamic Dependency Lifetime Manager (DDLM) package's family name, for arm64.
                    public const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.3000.934.1904.0-a6_8wekyb3d8bbwe";
                }
            }
        }
    }
