...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "TestMemoryLeaks.dll" comes first in this list. */
		"TestMemoryLeaks.dll",
		"MemoryToolkit.Maui.dll",
		...
		"Syncfusion.Maui.Carousel.dll",
		"Syncfusion.Maui.Chat.dll",
